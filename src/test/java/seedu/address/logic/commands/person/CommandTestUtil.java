...
public class CommandTestUtil {
    ...
    public static final String VALID_REMARK_LETTER = "A";
    ...
    public static final String REMARK_DESC_AMY = " " + PREFIX_REMARK + VALID_REMARK_LETTER;
    ...
    public static final String INVALID_REMARK_DESC = " " + PREFIX_REMARK + " "; //Empty not allowed
